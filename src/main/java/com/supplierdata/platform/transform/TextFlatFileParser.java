...
/**
 * Normalizes legacy fixed-width / pipe-delimited "Text" FlatFiles, the
 * oldest supplier format in the original platform. Expected line format:
 * SUPPLIER|CRUISELINE|SHIP|SAILINGDATE|FARECODE
 */
@Component
public class TextFlatFileParser {

    private static final String DELIMITER = "\\|";

    public List<NormalizedSupplierRecord> normalize(Reader textReader) throws IOException {
